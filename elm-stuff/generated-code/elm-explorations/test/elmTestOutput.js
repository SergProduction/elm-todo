		...
		[
			...
			_List_fromArray(
				[
					...
					'change pos through map',
					function (_n0) {
						var task = author$project$TaskStruct$Task(
							{
								children: _List_fromArray(
									[
										author$project$TaskStruct$Task(
										{children: _List_Nil, lvl: 1, name: '1 lvl', pos: 0})
									]),
								lvl: 0,
								name: 'root',
								pos: 0
							});
						var shouldBeTask = author$project$TaskStruct$Task(
							{
								children: _List_fromArray(
									[
										author$project$TaskStruct$Task(
										{children: _List_Nil, lvl: 1, name: '1 lvl', pos: 3})
									]),
								lvl: 0,
								name: 'root',
								pos: 3
...
var author$project$Test$Generated$Main1362863382$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/beecoder/project/elm-todo/tests/Example.elm']),
		processes: 8,
...
_Platform_export({'Test':{'Generated':{'Main1362863382':{'init':author$project$Test$Generated$Main1362863382$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
